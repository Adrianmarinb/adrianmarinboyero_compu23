...
# Parámetros
# ========================================
file_in = "mision_lunar.txt" # Nombre del fichero de datos
...
#planet_radius = 0.5 
planet_radius = [0.0165925, 0.00452003, 0.005]
...
#planet_color = "blue"
planet_colors = ["blue", "grey", "red", "blue", "red", "brown", "#EAD6B8", "#ACE5EE", "#4b70dd"]
