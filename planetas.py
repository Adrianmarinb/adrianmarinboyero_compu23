# -*- coding: utf-8 -*-
"""
Created on Wed Mar 15 17:04:53 2023
...
# Parámetros
# ========================================
file_in = "planets_data_adrian.dat" # Nombre del fichero de datos
...
#planet_radius = 0.5 
planet_radius = [0.2, 0.2, 0.2, 0.3, 0.4, 0.7, 0.6, 0.7, 0.7]


# Colores de los planetas
# Puede ser una lista de colores (una por cada planeta) o un único color
# que se usará para todos los planetas
#planet_color = "blue"
planet_colors = ["yellow", "#e5e5e5", "#8B7D82", "blue", "red", "brown", "#EAD6B8", "#ACE5EE", "#4b70dd"]
...
for planet_pos, radius, color in zip(frames_data[0], planet_radius, planet_colors):
    ...
    planet_point = Circle((x, y), radius, facecolor=color)
